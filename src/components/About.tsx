...
<div className="glass-card p-8 rounded-2xl">
  ...
  <div className="grid grid-cols-2 gap-4 mt-6">
    <div className="text-center p-4 bg-gray-800/50 rounded-lg">
      <div className="text-lg font-semibold text-cyan-400">Team Size</div>
      <div className="text-sm text-gray-400">1 to 4</div>
    </div>
    <div className="text-center p-4 bg-gray-800/50 rounded-lg">
      <div className="text-lg font-semibold text-yellow-400">Dates</div>
      <div className="text-sm text-gray-400">10 & 11 Aug, 2024</div>
    </div>
    <div className="text-center p-4 bg-gray-800/50 rounded-lg col-span-2">
      <div className="text-lg font-semibold text-green-400">Prizes</div>
