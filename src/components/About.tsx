      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="glass-card p-8 rounded-2xl">
            <div className="flex items-center mb-6">
              <Users className="w-8 h-8 text-purple-400 mr-4" />
              <h3 className="text-2xl font-bold text-white font-heading">IEEE UVCE & Computer Society</h3>
            </div>
            <p className="text-gray-300 leading-relaxed mb-4 font-content">
              IEEE UVCE Student Branch, established in 2001, is one of the most active technical communities 
              at University Visvesvaraya College of Engineering. We foster innovation, technical excellence, 
              and professional development among students.
            </p>
            <p className="text-gray-300 leading-relaxed font-content">
            The 'IEEE UVCE Computer Society' is a distinguished technical society within IEEE UVCE. It is dedicated to hosting regular technical events like coding competitions and hackathons that tackle current societal issues and create a positive impact. The main goal is to foster a dynamic and skilled student community by encouraging technical excellence and innovation.
            </p>
            <div className="flex items-center space-x-4 mt-6">
              <div className="flex items-center">
                <Globe className="w-5 h-5 text-cyan-400 mr-2" />
                <span className="text-cyan-400 font-content">500+ Members</span>
              </div>
              <div className="flex items-center">
                <Award className="w-5 h-5 text-purple-400 mr-2" />
                <span className="text-purple-400 font-content">15+ Years</span>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-8 rounded-2xl">
            <div className="flex items-center mb-6">
              <Target className="w-8 h-8 text-cyan-400 mr-4" />
              <h3 className="text-2xl font-bold text-white font-heading">About CodeFury</h3>
            </div>
            <p className="text-gray-300 leading-relaxed mb-4 font-content">
              CodeFury is our flagship Annual National-Level Hackathon that brings together the brightest minds in 
              programming and innovation. This 24-hour intensive coding marathon challenges participants 
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                <div className="text-2xl font-bold text-cyan-400 font-content">500+</div>
                <div className="text-sm text-gray-400 font-content">Participants</div>
              </div>
              <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                <div className="text-2xl font-bold text-purple-400 font-content">24hrs</div>
                <div className="text-sm text-gray-400 font-content">Non-stop</div>
              </div>
              <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                <div className="text-2xl font-bold text-green-400 font-content">₹60K+</div>
                <div className="text-sm text-gray-400 font-content">Prize Pool</div>
              </div>
              <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                <div className="text-2xl font-bold text-yellow-400 font-content">100%</div>
                <div className="text-sm text-gray-400 font-content">Online</div>
              </div>
            </div>
          </div>
        </div>
