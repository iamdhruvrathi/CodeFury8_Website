      ...
      <div className="container mx-auto px-6">  
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">  
          ...
          <div className="p-[2px] rounded-2xl bg-gradient-to-r from-cyan-500 to-purple-500">  
            <div className="glass-card p-8 rounded-2xl bg-gray-900/80 backdrop-blur-md">  
              ...
              <p className="text-gray-300 leading-relaxed">  
                The <span className="text-cyan-400">'IEEE UVCE Computer Society'</span> is a distinguished technical society within IEEE UVCE.  
                It is dedicated to hosting regular technical events like coding competitions and hackathons  
                that tackle current societal issues and create a positive impact. The main goal is to foster a  
                dynamic and skilled student community by encouraging technical excellence and innovation.  
              </p>  
          ...
          {/* About CodeFury */}  
          <div className="p-[2px] rounded-2xl bg-gradient-to-r from-purple-500 to-cyan-500">  
            <div className="glass-card p-8 rounded-2xl bg-gray-900/80 backdrop-blur-md">  
              <div className="flex items-center mb-6">  
