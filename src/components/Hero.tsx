...
// import cslogo from '../assets/image.png';
// import ieeelogo from '../assets/ieee-logo.png';
// import closedImg from '../assets/closed-img.jpg'; // Assume you saved the image as closed-img.jpg
...
//   useEffect(() => {
//     const now = new Date();
//     const closingTime = new Date('2025-07-29T13:00:00');
//     if (now >= closingTime) setIsClosed(true);
//     const interval = setInterval(() => {
//       if (new Date() >= closingTime) setIsClosed(true);
//     }, 60000);
...
//         <div className="flex justify-center mb-12">
//           {isClosed ? (
//             <div className="text-white text-xs sm:text-sm md:text-base bg-[#0f0f0f] px-4 py-2 rounded-md font-mono w-full text-center">
//                 <span className="text-gray-400 mr-2">&gt;&gt;&gt; REGISTRATIONS CLOSED</span>
//                 <span className="font-bold">
//                            THE REGISTRATIONS FOR CODEFURY 8.0 WERE CLOSED ON{" "}
//                 <span className="text-cyan-400 font-bold">
//                 20<sup>th</sup> August 2025
...
const Hero = () => {
  ...
  useEffect(() => {
    const now = new Date();
    const closingTime = new Date('2025-08-21T12:00:00');
    if (now >= closingTime) setIsClosed(true);
    const interval = setInterval(() => {
      if (new Date() >= closingTime) setIsClosed(true);
    }, 60000);
